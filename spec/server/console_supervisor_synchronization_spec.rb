...
RSpec.describe Consolle::Server::ConsoleSupervisor do
  ...
  describe 'process synchronization' do
    before do
      ...
      @created_threads = []
      allow(Thread).to receive(:new) do |*_args|
    ...
    it 'handles process death gracefully' do
      ...
      allow(Process).to receive(:waitpid).with(12_345, Process::WNOHANG).and_return(12_345)
